...
1. Проверьте существующие [Issues](https://github.com/lQwestl/opkg-upgrade/issues)
2. Создайте новый Issue с подробным описанием проблемы
3. Приложите вывод команды с флагом `-h` и информацию о системе

---

**Версия**: 0.4.1  
**Автор**: lQwestl  
**Репозиторий**: https://github.com/lQwestl/opkg-upgrade
